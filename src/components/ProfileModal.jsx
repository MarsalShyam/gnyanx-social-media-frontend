...
const ProfileModal = ({setShowEdit}) => {
  ...
  return (
    <div className='fixed top-0 buttom-0 left-0 right-0 z-110 h-screen overflow-y-scroll bg-black/50'>
        ...
        <div className='bg-white rounded-lg shadow p-6'>
            ...
            <form className='space-y-4' onSubmit={handleSaveProfile}>
                ...
                <div>
                    ...
                    <textarea rows={3} className='w-full p-3 border border-gray-200 rounded-lg' placeholder='Please fill the short Bio' onChange={(e)=>setEditForm({...editForm,bio:e.target.value})} value={editForm.bio}/>
                </div>
                ...
                <div>
                    ...
                    <input type='text' className='w-full p-3 border border-gray-200 rounded-lg' placeholder='Please enter your full name' onChange={(e)=>setEditForm({...editForm,location:e.target.value})} value={editForm.location}/>
                </div>
